...
x, y, time, iter, Error_fp, Error_gap = FBF(A=A, a=a, b=b, rp_x=rp_x, reg_x=reg_x, rp_y=rp_y, reg_y=reg_y, x0=x0, y0=y0, LR=LR, batch_size=batch_size, max_iter=max_iter, eps=eps)
